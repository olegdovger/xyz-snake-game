...
DifficultySettings::DifficultySettings(float baseSnakeSpeed, float speedIncreaseRate, float itemSpawnInterval,
                                       uint8_t maxItemsOnBoard, float appleLifetimeMultiplier, float specialItemChance,
                                       uint8_t wallCount)
...
void DifficultySettings::setItemParameters(float spawnInterval, uint8_t maxItems, float lifetimeMultiplier,
                                           float specialChance) {
